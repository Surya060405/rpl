...
const pools: Pool[] = [
    {
        ...
        gender: "Boys",
        teams: [
            { name: "AERO+ARCHI", played: 1, won: 1, lost: 0, nrr: 0.333, points: 2 },
            { name: "MSC+PHD", played: 1, won: 1, lost: 0, nrr: 0.167, points: 2 },
            { name: "ELECTRICAL", played: 0, won: 0, lost: 0, nrr: 0, points: 0 },
            { name: "MECHANICAL", played: 1, won: 0, lost: 1, nrr: -0.167, points: 0 },
            { name: "CST", played: 1, won: 0, lost: 1, nrr: -0.333, points: 0 },
        ],
    },
    {
        name: "Pool B",
        gender: "Boys",
        teams: [
            { name: "CIVIL", played: 2, won: 2, lost: 0, nrr: 5.833, points: 4 },
            { name: "META+MINING", played: 2, won: 1, lost: 1, nrr: -1.451, points: 2 },
            { name: "ETC", played: 0, won: 0, lost: 0, nrr: 0, points: 0 },
            { name: "IT", played: 1, won: 0, lost: 1, nrr: -1.042, points: 0 },
            { name: "MTECH", played: 1, won: 0, lost: 1, nrr: -7.5, points: 0 },
        ],
    },
    {
        name: "Girls Pool",
