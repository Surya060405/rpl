...
const pools: Pool[] = [
    {
        ...
        teams: [
            ...
            { name: "MECHANICAL", played: 3, won: 2, lost: 1, rd: 5, points: 6 },
            { name: "MSC+PHD", played: 3, won: 1, lost: 2, rd: -2, points: 3 },
            { name: "META+MINING", played: 2, won: 0, lost: 2, rd: -6, points: 0 },
            { name: "ETC", played: 2, won: 0, lost: 2, rd: -6, points: 0 },
        ],
    },
    {
        name: "Pool B",
        gender: "Boys",
        teams: [
            { name: "CST", played: 3, won: 3, lost: 0, rd: 7, points: 9, qualified: true },
            { name: "ELECTRICAL", played: 3, won: 2, lost: 1, rd: 2, points: 6 },
            { name: "AERO+ARCHI", played: 4, won: 2, lost: 2, rd: -1, points: 6 },
            { name: "CIVIL", played: 3, won: 1, lost: 2, rd: -1, points: 3 },
            { name: "MTECH", played: 3, won: 0, lost: 3, rd: -7, points: 0 },
        ],
    },
    {
        name: "Girls Pool",
        ...
        teams: [
            ...
            { name: "Pandya Hall", played: 1, won: 0, lost: 1, rd: -1, points: 0 },
        ],
    },
];
