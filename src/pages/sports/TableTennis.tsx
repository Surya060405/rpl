...
const pools: Pool[] = [
    {
        ...
        gender: "Boys",
        teams: [
            { name: "IT", played: 4, won: 4, lost: 0, rd: 9, points: 12, qualified: true },
            { name: "MECHANICAL", played: 4, won: 3, lost: 1, rd: 8, points: 9, qualified: true },
            { name: "MSC+PHD", played: 4, won: 2, lost: 2, rd: 1, points: 6 },
            { name: "ETC", played: 4, won: 1, lost: 3, rd: -7, points: 3 },
            { name: "META+MINING", played: 4, won: 0, lost: 4, rd: -11, points: 0 },
        ],
    },
    {
        name: "Pool B",
        gender: "Boys",
        teams: [
            { name: "CST", played: 4, won: 4, lost: 0, rd: 10, points: 12, qualified: true },
            { name: "ELECTRICAL", played: 4, won: 3, lost: 1, rd: 5, points: 9, qualified: true },
            { name: "AERO+ARCHI", played: 4, won: 2, lost: 2, rd: -1, points: 6 },
            { name: "CIVIL", played: 4, won: 1, lost: 3, rd: -4, points: 3 },
            { name: "MTECH", played: 4, won: 0, lost: 4, rd: -10, points: 0 },
        ],
    },
    {
        name: "Girls Pool",
        gender: "Girls",
        teams: [
            { name: "Pandya Hall", played: 2, won: 1, lost: 1, rd: 1, points: 3 },
            { name: "Lt. Williams", played: 1, won: 1, lost: 0, rd: 1, points: 3 },
            { name: "Sister Nivedita", played: 1, won: 0, lost: 1, rd: -2, points: 0 },
        ],
    },
];
